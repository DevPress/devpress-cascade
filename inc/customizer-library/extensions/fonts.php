...
function customizer_library_get_google_font_subsets() {
	return array(
		'all'          => __( 'All', 'cascade' ),
		'cyrillic'     => __( 'Cyrillic', 'cascade' ),
		'cyrillic-ext' => __( 'Cyrillic Extended', 'cascade' ),
		'devanagari'   => __( 'Devanagari', 'cascade' ),
		'greek'        => __( 'Greek', 'cascade' ),
		'greek-ext'    => __( 'Greek Extended', 'cascade' ),
		'khmer'        => __( 'Khmer', 'cascade' ),
		'latin'        => __( 'Latin', 'cascade' ),
		'latin-ext'    => __( 'Latin Extended', 'cascade' ),
		'vietnamese'   => __( 'Vietnamese', 'cascade' ),
	);
}
endif;
...
function customizer_library_get_standard_fonts() {
	return array(
		'serif' => array(
			'label' => _x( 'Serif', 'font style', 'cascade' ),
			'stack' => 'Georgia,Times,"Times New Roman",serif'
		),
		'sans-serif' => array(
			'label' => _x( 'Sans Serif', 'font style', 'cascade' ),
			'stack' => '"Helvetica Neue",Helvetica,Arial,sans-serif'
		),
		'monospace' => array(
			'label' => _x( 'Monospaced', 'font style', 'cascade' ),
